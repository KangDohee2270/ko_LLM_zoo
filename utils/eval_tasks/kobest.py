...
import numpy as np
from utils.eval_tasks.base import MultipleChoiceTask, rf, Task
from utils.eval_tasks.metrics import macro_f1_score, mean
...
class WiC(Task):
    ...
    def doc_to_text(self, doc):
        return "문장1: {} 문장2: {} 두 문장에서 {}가 같은 뜻으로 쓰였나?".format(
