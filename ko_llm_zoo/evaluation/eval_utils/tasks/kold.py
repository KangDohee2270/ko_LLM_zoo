...
"""
import inspect
import eval_utils.datasets.kold as kold
import numpy as np
from eval_utils.base import MultipleChoiceTask, rf, Task
from eval_utils.metrics import macro_f1_score, mean, f1_score
...
class KoldLevelA(Task):
    VERSION = 0
    DATASET_PATH = inspect.getfile(kold)
    DATASET_NAME = "kolda"
    ...
    def _process_doc(self, doc):
        ...
        return {"prompt": format_example(doc), "label": doc["off"]}
